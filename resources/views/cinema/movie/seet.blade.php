...
<head>
    ...
    <!-- //Meta-Tags -->
    <!-- Index-Page-CSS -->
    <link rel="stylesheet" href="{{ asset('styleseet/css/style.css ') }}" type="text/css" media="all">
...
<body onload="onLoaderFunc()">
                ...
                <section class="button-area">
                    <div class="container border-top-generic">
                        <div class="button-group-area mt-30">
                            <button> <a href="{{Route('receipt')}}" target="_blank">Pay Now</button>
                        </div>
                    </div>
                </section>
            </div>
    ...
    <!-- js -->
    <script src="{{ asset('styleseet/js/jquery-2.2.3.min.js ') }}"></script>
    <!-- //js -->
